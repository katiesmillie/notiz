# RailsAdmin config file. Generated on January 07, 2014 19:21
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Notiz', 'Admin']
  ...
  # config.excluded_models = ['Note', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Note', 'User']
